    ...
    <div className='p-6'>
      ...
      <div className='flex items-center mb-6'>
        <div className='relative w-full max-w-xs'>
          <select className='w-full appearance-none bg-white border border-gray-300 rounded-md py-2 pl-3 pr-10 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-[#4AA4DE] focus:border-transparent'>
            <option>Lektion 1: ا</option>
            <option>Lektion 2: ب</option>
            <option>Lektion 3: ت</option>
          </select>
      ...
      <div className='bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-6'>
        ...
        <div className='flex justify-center'>
          ...
          >
            <Link href='/quizzes/1'>Los geht&apos;s!</Link>
          </Button>
        </div>
      </div>
    </div>
