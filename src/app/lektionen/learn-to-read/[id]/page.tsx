...
export default function Page(props) {
  ...
  const lessons = [
    ...
    { id: 2, title: "ب", arabic: "Ba", description: "The second letter of the Arabic alphabet" },
  ...
  return (
    <div className="p-6">
      <div className="flex items-center mb-6">
        <Link href="/lektionen/learn-to-read" className="text-[#4AA4DE] hover:underline mr-2">
          &larr; Back to lessons
        </Link>
      </div>
      
      <h1 className="text-2xl font-bold mb-1">Lesson {lesson.id}: {lesson.title} ({lesson.arabic})</h1>
      ...
      <div className="flex justify-between">
        {lessonId > 1 && (
          <Button asChild variant="outline" className="flex items-center">
            <Link href={`/lektionen/learn-to-read/${lessonId - 1}`}>
