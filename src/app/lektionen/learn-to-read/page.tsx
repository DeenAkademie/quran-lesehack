...
export default function LearnToReadPage() {
  ...
  return (
    <div className="p-6">
      ...
      <h1 className="text-2xl font-bold mb-1">Learn to read</h1>
      <p className="text-gray-500 mb-6">Learn to read the Quran step by step.</p>
      ...
      <div className="border border-gray-200 rounded-b-lg p-6 mb-6">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h3 className="font-medium">Current lesson</h3>
            <p>Lesson 1: Introduction to Arabic letters</p>
          </div>
        ...
        <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4">
          <div className="bg-[#4AA4DE] h-2.5 rounded-full" style={{ width: '10%' }}></div>
        </div>
        
        <div className="text-sm text-gray-500">
          10% complete (1/10 lessons)
        </div>
      </div>
          ...
          {lessons.map((lesson) => (
            <div key={lesson.id} className="border border-gray-200 rounded-lg overflow-hidden">
              <div className="relative">
                <div className={`aspect-video ${lesson.unlocked ? '' : 'opacity-50'}`}>
                  <Image 
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="bg-gray-500 rounded-full p-2">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M8 10V6C8 3.79086 9.79086 2 12 2C14.2091 2 16 3.79086 16 6V10" stroke="white" strokeWidth="2" />
                      </svg>
                    </div>
                  </div>
                )}
              ...
              <div className="p-4">
                <div className="flex justify-between items-center">
                  <h2 className="text-lg font-medium">Lesson {lesson.id}: <span className="text-xl">{lesson.title}</span></h2>
                </div>
                {lesson.unlocked ? (
                  <Button 
                    asChild
                  ...
                  >
                    <Link href={`/lektionen/learn-to-read/${lesson.id}`}>
                      Watch video
                    </Link>
                  </Button>
                ) : (
