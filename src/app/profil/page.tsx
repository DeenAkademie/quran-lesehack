              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  <div className="text-center p-4 bg-muted rounded-lg">
                    <p className="text-3xl font-bold">{user.completedLessons}</p>
                    <p className="text-sm text-muted-foreground">von {user.totalLessons} Lektionen</p>
                  </div>
                  <div className="text-center p-4 bg-muted rounded-lg">
                ...
                <CardContent>
                  <ul className="space-y-4">
                    {user.achievements.map((achievement) => (
                      <li key={achievement.id} className="flex justify-between items-center border-b pb-2 last:border-0">
